				...
				<div class="hidden-xs">
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							<li {if $type == ''}class="active"{/if}><a href="{url base='albums' strip='type' value=''}">{t c='global.all'}</a></li>
							<li {if $type == 'public'}class="active"{/if}><a href="{url base='albums' strip='type' value='public'}">{t c='global.public'}</a></li>
							<li {if $type == 'private'}class="active"{/if}><a href="{url base='albums' strip='type' value='private'}">{t c='global.private'}</a></li>
						</ul>
					</div>
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							<li {if $timeframe == 'a'}class="active"{/if}><a href="{url base='albums' strip='t' value='a'}">{t c='global.all'}</a></li>							
							<li {if $timeframe == 't'}class="active"{/if}><a href="{url base='albums' strip='t' value='t'}">{t c='global.added'} {t c='global.today'}</a></li>
							<li {if $timeframe == 'w'}class="active"{/if}><a href="{url base='albums' strip='t' value='w'}">{t c='global.added'} {t c='global.this_week'}</a></li>
							<li {if $timeframe == 'm'}class="active"{/if}><a href="{url base='albums' strip='t' value='m'}">{t c='global.added'} {t c='global.this_month'}</a></li>
						</ul>
					</div>					
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							<li {if $order == 'mr'}class="active"{/if}><a href="{url base='albums' strip='o' value='mr'}">{t c='global.most_recent'}</a></li>
							<li {if $order == 'mv'}class="active"{/if}><a href="{url base='albums' strip='o' value='mv'}">{t c='global.most_viewed'}</a></li>
							<li {if $order == 'mp'}class="active"{/if}><a href="{url base='albums' strip='o' value='mp'}">{t c='album.most_photos'}</a></li>
							<li {if $order == 'tr'}class="active"{/if}><a href="{url base='albums' strip='o' value='tr'}">{t c='global.top_rated'}</a></li>
							<li {if $order == 'md'}class="active"{/if}><a href="{url base='albums' strip='o' value='md'}">{t c='global.most_commented'}</a></li>
							<li {if $order == 'tf'}class="active"{/if}><a href="{url base='albums' strip='o' value='tf'}">{t c='global.top_favorites'}</a></li>
						</ul>
					</div>					
				</div>	
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-4">
			<div class="list-group">
				...
				<a href="{url base='albums' strip='c' value=$categories[i].CHID}" {if $category == $categories[i].CHID}class="list-group-item active"{else}class="list-group-item"{/if}>
					{$categories[i].name}
				</a>
				{/section}
			</div>
