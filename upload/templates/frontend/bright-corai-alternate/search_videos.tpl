			...
			<div class="pull-left m-l-20">
				<div class="hidden-xs">
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							<li {if $order == 'bw'}class="active"{/if}><a href="{url base='search' strip='o' value='bw'}">{t c='global.being_watched'}</a></li>						
							...
							<li {if $order == 'lg'}class="active"{/if}><a href="{url base='search' strip='o' value='lg'}">{t c='global.longest'}</a></li>
						</ul>
					</div>					
				</div>	
