			...
			{if isset($smarty.session.uid)}
				<li>会员剩余时间：
						...
						{elseif $user_vip_info.vip_level=='7'}
							终身超级VIP
						{else}
							{$user_vip_info.vip_time_left|number_format:'0'}天
						{/if}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="{$relative}/"><img src="{$relative_tpl}/img/logo.png"></a> 
		</div>
		<div class="navbar-collapse collapse navbar-inverse-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<ul class="dropdown-menu search-dropdown-menu">
					<form class="form-inline" name="search" id="search_form" method="get" action="{$relative}/search">
