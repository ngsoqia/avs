			...
			<div class="col-md-8">
					...
					<div class="pull-right m-t-15 m-r-5">
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li><a href="{$baseurl}/download.php?id={$video.VID}">SD (FLV/MP4)</a></li>
				...
				<div class="m-t-10 overflow-hidden">
					...
					{section name=i loop=$keywords}
						<a class="tag" href="{$relative}/search?search_type=videos&search_query={$keywords[i]}">{$keywords[i]}</a>{if !$smarty.section.i.last},{/if}
					{/section}						
				</div>
