<div class="container">
	...
	<div class="well well-filters">
			<div class="pull-left">
				<h4>{t c='search.title'}<span class="hidden-xs hidden-sm"> - {t c='global.users'}</span></h4>
			</div>
				...
				<div class="hidden-xs">
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							<li {if $interest == ''}class="active"{/if}><a href="{url base='search' strip='i' value=''}">{t c='global.any'}</a></li>
							<li {if $interest == 'Guys'}class="active"{/if}><a href="{url base='search' strip='i' value='Guys'}">{t c='global.guys'}</a></li>
							<li {if $interest == 'Girls'}class="active"{/if}><a href="{url base='search' strip='i' value='Girls'}">{t c='global.girls'}</a></li>
							<li {if $interest == 'Guys + Girls'}class="active"{/if}><a href="{url base='search' strip='i' value='Guys%2BGirls'}">{t c='global.guys_girls'}</a></li>
						</ul>
					</div>
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							<li {if $avatar == ''}class="active"{/if}><a href="{url base='search' strip='a' value=''}">{t c='global.any'}</a></li>							
							<li {if $avatar == 'yes'}class="active"{/if}><a href="{url base='search' strip='a' value='yes'}">{t c='avatar.yes'}</a></li>
							<li {if $avatar == 'no'}class="active"{/if}><a href="{url base='search' strip='a' value='no'}">{t c='avatar.no'}</a></li>
						</ul>
					</div>					
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							...
							<li {if $order == 'ma'}class="active"{/if}><a href="{url base='search' strip='o' value='ma'}">{t c='global.most_active'}</a></li>
							<li {if $order == 'mp'}class="active"{/if}><a href="{url base='search' strip='o' value='mp'}">{t c='global.most_popular'}</a></li>
							<li {if $order == 'tr'}class="active"{/if}><a href="{url base='search' strip='o' value='tr'}">{t c='global.top_rated'}</a></li>
							<li {if $order == 'on'}class="active"{/if}><a href="{url base='search' strip='o' value='on'}">{t c='global.online_now'}</a></li>
						</ul>
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-4">
			<div class="list-group">
				<a href="{url base='search' strip='g' value=''}" {if $gender == ''} class="list-group-item active"{else}class="list-group-item"{/if}>{t c='global.any'}</a></li>							
				<a href="{url base='search' strip='g' value='Male'}"  {if $gender == 'Male'}class="list-group-item active"{else}class="list-group-item"{/if}>{t c='global.male'}</a></li>
				<a href="{url base='search' strip='g' value='Female'}"  {if $gender == 'Female'}class="list-group-item active"{else}class="list-group-item"{/if}>{t c='global.female'}</a></li>	
			</div>
