<div class="footer-container">
	...
	<div class="footer">
		<div class="container">
			<div class="hidden-xs">
				<div class="pull-left">
					<span>{t c='footer.copyright'} &#169; 2008-2015</span> {$site_name}
				</div>
			...
			<div class="visible-xs"><span>{t c='footer.copyright'} &#169; 2008-2015</span> {$site_name}<br />Powered by <a target="_blank" href="http://www.adultvideoscript.com">AVS</a></div>
		</div>
	</div>
</div>
</div>
